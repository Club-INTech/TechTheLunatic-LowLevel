...
private:
	...
	AX<serial_ax>* ax12FingerRightFishes; // Doigt pour d�crocher les poissons
	AX<serial_ax>* ax12MagnetsLeft; // Bras gauche pour pecher les poissons
	AX<serial_ax>* ax12FingerLeftFishes; // Doigt gauche pour d�crocher les poissons
...
public:
	...
	void setAXposMagnetsRight(int position) { // pour d�finir manuellement 1 position
		ax12MagnetsRight->goTo(position);
	}
	void setAXposMagnetsLeft(int position) { // pour d�finir manuellement 1 position
		ax12MagnetsLeft->goTo(position);
	}
	void setAXposFreeRightFishes(int position) { // pour d�finir manuellement 1 position
		ax12FingerRightFishes->goTo(position);
	}
	void setAXposFreeLeftFishes(int position) { // pour d�finir manuellement 1 position
