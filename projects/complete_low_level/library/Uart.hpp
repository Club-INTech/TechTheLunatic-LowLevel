...
public:
	...
	static inline void init(uint32_t baudrate) {
		...
		USART_InitStruct.USART_WordLength = USART_WordLength_8b; // octet comme taille �l�mentaore (standard)
		USART_InitStruct.USART_StopBits = USART_StopBits_1; // bit de stop = 1 (standard)
		USART_InitStruct.USART_Parity = USART_Parity_No; // pas de bit de parit� (standard)
